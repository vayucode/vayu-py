...
class GetProductsUsageReportResponse(BaseModel):
    """
    ...
    commitment_consumption_percentage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="commitmentConsumptionPercentage")
    total_commitment_currency_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalCommitmentCurrencyAmount")
    total_commitment_units_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalCommitmentUnitsAmount")
    ...
    currency: Currency
    usage_consumption_currency_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="usageConsumptionCurrencyAmount")
    usage_consumption_units_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="usageConsumptionUnitsAmount")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["contractStatus", "customerName", "startDate", "endDate", "contractStartDate", "daysToContractEnd", "productVariantName", "commitmentConsumptionPercentage", "totalCommitmentCurrencyAmount", "totalCommitmentUnitsAmount", "commercialTermsAmount", "erpId", "currency", "usageConsumptionCurrencyAmount", "usageConsumptionUnitsAmount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetProductsUsageReportResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetProductsUsageReportResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "usageConsumptionCurrencyAmount": obj.get("usageConsumptionCurrencyAmount"),
            "usageConsumptionUnitsAmount": obj.get("usageConsumptionUnitsAmount")
        })
